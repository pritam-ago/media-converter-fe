...
import { Eye, EyeOff, Lock, Mail, User, AlertTriangle, RefreshCw } from "lucide-react"
...
export function SignupForm() {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Welcome to Media Converter!",
        })
  ...
  // Function to handle mock signup (fallback when API is not available)
  const handleMockSignup = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "This is a mock signup for testing. No actual API call was made.",
      })
          ...
          <div className="mt-4 text-xs text-gray-500 text-center">
            ...
            {apiStatus === "offline" && (
              <div className="mt-3 p-2 bg-yellow-50 dark:bg-yellow-900/20 rounded text-yellow-800 dark:text-yellow-200">
                ...
                <p className="mt-1">You can use the mock signup for testing:</p>
                <Button
                  variant="outline"
                  size="sm"
                  ...
                  disabled={isLoading}
                >
                  {isLoading ? "Processing..." : "Use Mock Signup"}
                </Button>
              </div>
            )}
          </div>
